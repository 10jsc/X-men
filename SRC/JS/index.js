...
// console.log('olá J!') serve para inspecionar no navegador
/*const itemCiclope = document.getElementById('ciclope')
console.log(
    itemCiclope
);*/

// A variável, o valor da variável const não pode ser alterado/modificado

const personagens = document.querySelectorAll('.personagem');
/*consol.log(); para inspecionar no navegador */
...
}/*Interpolação de estrings, troca a aspas por crase `` permite adicionar ${id} */
